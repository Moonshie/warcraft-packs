...
const templates = {
    'Classic Booster': boosterTemplate,
    'Starter Deck': bigBoxTemplate,
}
...
function exportTTS() {
    renderedItems.forEach(item => {
        ...
        let templateCopy = Object.assign({}, templates[item.type]);
        ...
        templateCopy.ObjectStates[0].ContainedObjects = [];
    });
}
...
function exportBooster(item, templateCopy) {
    item.cardContents.forEach(cardData => {
        ...
        templateCopy.ObjectStates[0].ContainedObjects.push(cardCopy);
    });
}
